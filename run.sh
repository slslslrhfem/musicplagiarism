...
python3 LStoM/process_data.py -i LStoM/POP909 -o ./processed_data -q $@
...
python LStoM/predict.py -i ./output.midi.mid -sd ./yaml_files/stats_config_train_valid.yaml -m ./model_results/test_model.pt -o ./separated_melody -q
